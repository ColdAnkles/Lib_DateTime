...
[h: "<!-- Add 'setExpire' to enable expiry -->"]
...
[h, if(json.contains(macro.args,"Save")), code:{
	...
	[h: silent = if(json.contains(macro.args,"silent"),json.get(macro.args,"silent"),json.null)]
	...
	[h: event = json.set("{}","name",json.get(macro.args,"setEventName"),"description",json.get(macro.args,"setDescription"),"expire",if(json.contains(macro.args,"setExpire"),"true","false"),"gmOnly",if(json.contains(macro.args,"gmOnly"),"true","false"),"callBack",callBack,"silent",silent,"autoDelete",autoDelete,"uid",uid)]
